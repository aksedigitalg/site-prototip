...
export default function SearchPage() {
  ...
  const headerH = query.length > 0 ? 104 : 60
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center">
        <div className="w-full max-w-[430px] bg-white border-b border-gray-100" style={{ padding: '12px 16px' }}>
          <div className="flex items-center gap-3">
            ...
            >
              <ArrowLeft size={18} strokeWidth={2.5} className="text-gray-700" />
            </button>
            <div className="flex-1 flex items-center gap-2 bg-gray-100 rounded-2xl px-4" style={{ height: 40 }}>
      ...
      {/* ── İçerik ── */}
      <div className="pb-24" style={{ paddingTop: headerH }}>
        ...
        {query.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center pt-20 px-8 text-center">
            <div className="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center" style={{ marginBottom: 16 }}>
            ...
            <div className="flex flex-col divide-y divide-gray-100">
              {filtrelenmis.map(s => (
                <button
                  ...
                  className="flex items-center gap-3 active:bg-gray-50 transition-colors"
