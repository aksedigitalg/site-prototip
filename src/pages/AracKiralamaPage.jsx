...
import {
  ArrowLeft, Calendar, MapPin, Star, Users, ChevronRight,
  Zap, Settings,
} from 'lucide-react'
...
const VITES_ICON = { 'Manuel': '⚙️', 'Otomatik': '🤖' }
const YAKIT_COLOR = {
...
export default function AracKiralamaPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="w-full max-w-[430px] bg-white/90 backdrop-blur-md border-b border-gray-100 px-4 py-3">
          ...
          <div className="flex gap-2 mb-3">
            <div className="flex-1 bg-gray-100 rounded-xl px-3 py-2">
              <p className="text-gray-400 text-[10px] mb-0.5 flex items-center gap-1"><Calendar size={9} strokeWidth={2} />Alış Tarihi</p>
            ...
            <div className="flex-1 bg-gray-100 rounded-xl px-3 py-2">
              <p className="text-gray-400 text-[10px] mb-0.5 flex items-center gap-1"><Calendar size={9} strokeWidth={2} />İade Tarihi</p>
      ...
      <div className="pt-[220px] pb-24 px-4 flex flex-col gap-3">
        {liste.map(arac => {
